...
*/
public class Day7AmplificationCircuitPart2Working {
	...
	public static void main(String args[]) throws Exception {
		Day7AmplificationCircuitPart2Working day7AmplificationCircuitPart1 = new Day7AmplificationCircuitPart2Working();
...
//		Integer initialAmplifierSquence[] = {9,8,7,6,5};
//		
//		int intCodes[] = { 3, 52, 1001, 52, -5, 52, 3, 53, 1, 52, 56, 54, 1007, 54, 5, 55, 1005, 55, 26, 1001, 54, -5,
//				54, 1105, 1, 12, 1, 53, 54, 53, 1008, 54, 0, 55, 1001, 55, 1, 55, 2, 53, 55, 53, 4, 53, 1001, 56, -1,
//				56, 1005, 56, 6, 99, 0, 0, 0, 0, 10 };
//		Integer initialAmplifierSquence[] = { 9, 7, 8, 5, 6 };

		List<Integer[]> amplifierSquences = day7AmplificationCircuitPart1
				.getCombinationOfAmplifierSquence(initialAmplifierSquence);
...
//		amplifierSquences.add(initialAmplifierSquence);
	...
	int processSequence(Integer[] amplifierSquence, int[] intCodes) {
		...
		for (int phaseIndex = 0; phaseIndex < amplifierSquence.length; phaseIndex++) {
			...
			intCodeComputer.inputValues.add(input1);
		...
		while (!isProgramHalted) {
			for (IntCodeComputer intCodeComputer : intCodeComputers) {
				intCodeComputer.inputValues.add(input2);
				intCodeComputer.extractAndExecuteOptCodes();
				isProgramHalted = intCodeComputer.isProgramHalted;
	...
	static class IntCodeComputer {
		...
		private void extractAndExecuteOptCodes(int intCodes[], int startPosition) {
			...
			if (OPT_CODE_99 == optCode) {
				...
				int firstParamValue = firstParmeterMode == POSITION_MODE ? intCodes[intCodes[startPosition + 1]]
						: intCodes[startPosition + 1];
				int secondParamValue = secondParmeterMode == POSITION_MODE ? intCodes[intCodes[startPosition + 2]]
						: intCodes[startPosition + 2];
