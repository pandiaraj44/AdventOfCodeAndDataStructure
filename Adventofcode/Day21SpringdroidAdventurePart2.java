...
*/
public class Day21SpringdroidAdventurePart2 implements AOC<Long>{
	...
	public static void main(String args[]) throws Exception {
		Day21SpringdroidAdventurePart2 day21SpringdroidAdventurePart1 = new Day21SpringdroidAdventurePart2();
	...
	Queue<String> generateInstructionFunction() {
		...
		instructionFunction.add("NOT A J");
		instructionFunction.add("NOT B T");
		instructionFunction.add("OR T J");
		instructionFunction.add("NOT C T");
		instructionFunction.add("OR T J");
		instructionFunction.add("AND D J");
		instructionFunction.add("NOT E T");
		instructionFunction.add("NOT T T");
		instructionFunction.add("OR H T");
	...
	static class IntCodeComputer {
		...
		private void extractAndExecuteOptCodes() {
			while(!Day21SpringdroidAdventurePart2.HALT_CODES.contains(this.haltCode)) {
