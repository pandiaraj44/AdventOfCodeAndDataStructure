...
*/
public class Day23CategorySixPart1 implements AOC<Long>{
	...
	public static void main(String args[]) throws Exception {
		Day23CategorySixPart1 day23CategorySixPart1 = new Day23CategorySixPart1();
		Long yValueOf255thPacket = day23CategorySixPart1.run();
    	System.out.println("What is the Y value of the first packet sent to address 255? " + yValueOf255thPacket);
	}
	...
	public Long run() {
		...
		yValueOf255thPacket = processIntecodeComputers();
		return yValueOf255thPacket;
	}	
	...
	static class IntCodeComputer {
		...
		private void extractAndExecuteOptCodes() {
			while(!Day23CategorySixPart1.HALT_CODES.contains(this.haltCode)) {
